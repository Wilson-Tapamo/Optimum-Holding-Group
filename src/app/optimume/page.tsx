...
import { HardHat, Truck, Wrench, Building } from "lucide-react";
...
export default function OptimumePage() {
  ...
  const services = [
    {
      ...
      items: ["Construction de bâtiments", "Infrastructures routières", "Ouvrages d'art", "Génie rural"],
    },
    {
      title: "Location d'engins lourds",
      icon: <Truck className="w-8 h-8 text-indigo-500" />,
      items: ["Pelles mécaniques", "Niveleuses", "Chargeuses", "Camions bennes", "Compacteurs"],
    },
    {
      title: "Maintenance industrielle",
      icon: <Wrench className="w-8 h-8 text-cyan-500" />,
      items: ["Entretien d'équipements", "Réparation d'engins", "Fourniture de pièces de rechange"],
    },
    {
      title: "Gestion de projets",
      icon: <HardHat className="w-8 h-8 text-sky-500" />,
      items: ["Études techniques", "Suivi et contrôle de travaux", "Maîtrise d'œuvre"],
    },
  ];
        ...
        <div className="container mx-auto px-4 z-10 text-center flex flex-col items-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-blue-100 font-light">
              Construction, BTP & Location d'engins lourds
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute bottom-0 w-full overflow-hidden bg-black/40 backdrop-blur-sm border-t border-white/10 py-4 z-10">
          ...
          >
            <span className="text-xl font-medium tracking-wide text-white/90">
              "L'excellence dans la réalisation de vos infrastructures"
            </span>
          </motion.div>
        </div>
      </section>
