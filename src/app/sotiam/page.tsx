...
import { ShieldCheck, HardDrive, Cpu, Settings } from "lucide-react";
import RecentWorks from "@/components/RecentWorks";

const images = [
  "/images/bg-sotiam.jpg",
  "/images/bg-3.jpg",
];

export default function SotiamPage() {
  ...
  const services = [
    {
      ...
      items: ["Fournitures de matériels informatiques", "Développement d'infrastructures IT", "Services clouds"],
    },
    {
      title: "Sécurité & Domotique",
      icon: <ShieldCheck className="w-8 h-8 text-indigo-500" />,
      items: ["Installation de caméras", "Contrôle d'accès", "Automatisation de bâtiments"],
    },
    {
      title: "Matériel Industriel",
      icon: <HardDrive className="w-8 h-8 text-cyan-500" />,
      items: ["Fourniture d'équipements spécialisés", "Machines pour l'industrie", "Pièces de rechange"],
    },
    {
      title: "Services & Maintenance",
      icon: <Settings className="w-8 h-8 text-sky-500" />,
      items: ["SAV réactif", "Maintenance préventive", "Formation des utilisateurs"],
    },
  ];
  ...
  return (
    <div className="min-h-screen">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Image
                ...
                onError={(e) => {
                  e.currentTarget.src = "/images/bg-3.jpg"; // Default fallback
                }}
                priority
              />
            </motion.div>
        ...
        <div className="container mx-auto px-4 z-10 text-center flex flex-col items-center">
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-blue-100 font-light">
              Technologies, Industries et Sécurité Intégrée
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute bottom-0 w-full overflow-hidden bg-black/40 backdrop-blur-sm border-t border-white/10 py-4 z-10">
          ...
          >
            <span className="text-xl font-medium tracking-wide text-white/90">
              "L'innovation technologique pour booster vos performances"
            </span>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-2">
              Pôle <span className="text-gradient">Technique</span>
            </h2>
      ...
      <RecentWorks images={[
        "/images/sotiam-ak1.jpeg", 
        "/images/sotiam-ak2.jpeg", 
        "/images/sotiam-ak3.jpeg"
      ]} />
    </div>
  );
}
